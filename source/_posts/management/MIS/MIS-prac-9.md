...
1. From your reading of the chapter's opening case, which of the answers below is not a reason why Lenzing chose JDA's Sales & Operations Planning software? {.quiz}
    ...
    - Develop a new business model {.correct}
{.options}

2. Which of the following provides a suite of integrated software modules and a common central database that allows data to be used by multiple functions and business processes? {.quiz}
...
3. Enterprise software is built around thousands of predefined business processes that reflect: {.quiz}
...
4. Which of the following is not true about enterprise systems? {.quiz}
    ...
    - Enterprise software is expressly built to allow companies to support their existing business practices. {.correct}
...
5. You have been asked to implement enterprise software for a manufacturer of kitchen appliances. What is the first step you should take? {.quiz}
    ...
    - Select the functions of the system you wish to use. {.correct}
{.options}

6. Which of the following enables a company to tailor a particular aspect of enterprise software to the way a company does business? {.quiz}
    - Configuration tables {.correct}
    - Web services
    - Data dictionaries
    - Middleware
    - Groupware
...
7. To achieve the maximum benefit of a new ERP system, Tasty Baking implemented an enterprise system by: {.quiz}
    ...
    - customizing less than 5 percent of the enterprise system processes. {.correct}
    - changing the ERP software as needed to match their own processes.
    - using a cloud-based version of the ERP.
{.options}

8. Coca-Cola implemented enterprise software from SAP that enabled it to achieve all of the following except: {.quiz}
    - standardizing business processes worldwide.
    - improving its bargaining power with suppliers.
    - reacting faster to market changes.
    - reducing the number of employees. {.correct}
    - reducing the cost of raw materials.
{.options}

9. Enterprise systems improve management decision making in all the following ways except: {.quiz}
    - providing up-to-the-minute data on sales, inventory, and production.
    - providing more accurate sales and production forecasts.
    - improving forecasts of consumer behavior. {.correct}
    - implementing standard definitions and formats worldwide.
    - determining the profitability of products.
{.options}

10. The total time it takes to complete a business process, from start to finish, is called its []{.gap} time. {.quiz}
    - development
    - cycle {.correct}
    - fulfillment
    - service
...
11. Enterprise systems are built around a small number of predefined business processes. {.quiz .false}

12. Organizations can rewrite enterprise system software to support their existing business processes. {.quiz .true}

13. To reap the maximum benefits from enterprise software, companies should customize it to conform to their existing business processes. {.quiz .false}
...
15. You have been hired by Santori, Inc., a small company that imports and distributes an Italian sparkling water. The company is interested in what benefits an enterprise system would bring. Would an enterprise system be appropriate for this company? What steps would you take in determining this?
...
16. What is an ERP system and how does it enable a firm to integrate firmwide information?
...
17. A network of organizations and business processes for procuring raw materials, transforming these materials into intermediate and finished products, and distributing the finished products to customers is called a(n): {.quiz}
...
18. In the supply chain, components or parts are referred to as: {.quiz}
    - upstream materials, organizations, and processes.
    - raw materials.
    - secondary products.
    - intermediate products. {.correct}
    - downstream organizations and processes.
{.options}

19. The []{.gap} includes a company's suppliers, the suppliers' suppliers, and the processes for managing relationships with them? {.quiz}
    - supplier's internal supply chain
    - logistics supply chain
    - downstream portion of the supply chain
    - upstream portion of the supply chain {.correct}
    - intermediate portion of the supply chain
{.options}

20. Distribution and delivery of products to retailers is part of the: {.quiz}
    - downstream portion of the supply chain. {.correct}
...
21. All of the following are examples of supply chain inefficiencies except: {.quiz}
    - parts shortages.
...
22. Supply chain inefficiencies waste as much as []{.gap} percent of a company's operating costs? {.quiz}
    - 10
    - 15
    - 25 {.correct}
    - 35
...
23. To eliminate excessively high inventories of its Pampers disposable diapers at various points along its supply chain because of such distorted information, Procter & Gamble did all of the following except: {.quiz}
    - revise its marketing processes.
    - revise its sales processes.
    - add safety stock. {.correct}
    - revise its supply chain processes.
    - use more accurate demand forecasting.
{.options}

24. In a []{.gap} strategy, components arrive exactly at the moment they are needed and finished goods are shipped as soon as they leave the assembly line. {.quiz}
...
25. A distortion of information about the demand for a product as it passes from one entity to the next across the supply chain is called the []{.gap} effect. {.quiz}
    - network
    - bullwhip {.correct}
    - ripple
    - whirlpool
...
26. Supply chain software can be classified as either supply chain []{.gap} systems or supply chain []{.gap} systems. {.quiz}
    - push; pull
    - demand; continual
    - upstream; downstream
...
27. Which of the following enables a firm to generate demand forecasts for a product and to develop sourcing and manufacturing plans for that product? {.quiz}
    - Supply chain demand system
    - Supply chain delivery system
    - Supply chain optimization system
    - Supply chain execution system
    - Supply chain planning system {.correct}
{.options}

28. Supply chain planning systems perform all of the following functions except: {.quiz}
    ...
    - track the physical status of goods. {.correct}
{.options}

29. Which supply chain planning function determines how much product is needed to satisfy all customer demands? {.quiz}
    - Distribution management
    - Replenishment planning
    - Demand planning {.correct}
    - Order planning
    - Customer planning
{.options}

30. Which of the following manages the flow of products through distribution centers and warehouses to ensure that products are delivered to the right locations in the most efficient manner? {.quiz}
    - Supply chain demand system
    - Supply chain delivery system
    - Supply chain planning system
    - Supply chain execution system {.correct}
    - Supply chain optimization system
{.options}

31. Supply chain execution systems provide all of the following functions except: {.quiz}
    - generating demand forecasts for products. {.correct}
...
32. A supply chain driven by forecasts or best guesses of consumer demand follows a(n) []{.gap} model. {.quiz}
    - pull-based
    - build-to-order
    - push-based {.correct}
    - demand-driven
...
33. A supply chain driven by actual customer orders is called a []{.gap} model. {.quiz}
    - supply-based
    - build-to-stock
...
34. Schneider National is an example of which of the following? {.quiz}
    - Contract manufacturer
    - Third-party logistics provider {.correct}
    - Tier 1 supplier
    - Distributor
    - Tier 2 supplier
{.options}

35. The business value of an effective supply chain management system includes all of the following except: {.quiz}
...
36. The bullwhip effect can be countered by: {.quiz}
    - globalization.
    - disintermediation.
    - implementing a CRM.
    - reducing information uncertainty. {.correct}
    - product differentiation.
{.options}

37. Which of the following is the last entity in the downstream portion of a supply chain? {.quiz}
    - Customers {.correct}
    - Retailers
    - Distributors
    - Manufacturers
...
38. Which of the following is not a major entity in Nike's supply chain? {.quiz}
    - Nike's contract suppliers
    - Nike's employees {.correct}
    - Nike's distributors
    - Nike's retailers
    - Nike's customers
{.options}

39. A company having difficulty with timely delivery of parts to its manufacturing plants should implement a []{.gap} system. {.quiz}
    - supply chain execution {.correct}
...
40. The difference between push- and pull-based models is summarized by which of the following slogans? {.quiz}
    - Sell what we make, not make what we sell.
    - Push what we make, not pull what we make.
    - Make what we sell, not sell what we make. {.correct}
    - Pull what we make, not push what we sell.
    - Make what we push, not push what we sell.
{.options}

41. Walmart's continuous replenishment system is an example of a(n) []{.gap} model. {.quiz}
    - push-based
    - pull-based {.correct}
    - build-to-stock
...
42. The WMS that Haworth Incorporated uses is an example of which of the following? {.quiz}
    - Supply chain execution system {.correct}
    - Supply chain planning system
...
43. Managing a global supply chain is more complex than managing a domestic supply chain. {.quiz .true}

44. The upstream portion of the supply chain consists of the organizations and processes for distributing and delivering products to the final customers. {.quiz .false}

45. In some industries, total supply chain costs can approach 75 percent of a company's operating budget. {.quiz .true}

46. Firms in the supply chain develop safety stocks in order to reduce the cost of inventory. {.quiz .false}

47. The bullwhip effect leads to declining inventory costs across the entire supply chain. {.quiz .false}

48. Supply chain planning systems enable the firm to model its existing supply chain. {.quiz .true}

49. Before the Internet, supply chain coordination was hampered by the difficulties of making information flow smoothly among different internal supply chain processes. {.quiz .true}

50. Inefficiencies in a supply chain are caused by inaccurate or untimely information. {.quiz .true}

51. In a push-based model, transactions to produce and deliver only what customers have ordered move up the supply chain from retailers to distributors to manufacturers and eventually to suppliers. {.quiz .false}

52. Contemporary supply chain management systems are driven by a push-based model in which production master schedules are based on forecasts of demand for products. {.quiz .false}

53. Procter & Gamble (P&G) experienced a growth in its Pampers diapers inventory due to the bullwhip effect. {.quiz .true}

54. The emerging Internet-driven supply chain provides multidirectional communication among firms, networks of firms, and e-marketplaces. {.quiz .true}

55. Identify two classifications for supply chain software. What are the capabilities of each type?
...
56. What additional complexities are faced in global supply chains? How does the Internet help in managing global supply chains?
...
57. How does a push-based model of manufacturing differ from a pull-based model? Which is better and why?
...
58. Plant Away is an Oregon-based retailer and distributor of trees and shrubs. It has hundreds of smaller nurseries based around the country that grow the plant stock. The majority of its business is conducted online. Consumers typically purchase small quantities of products online and Plant Away coordinates the shipping from the most appropriate nursery. What unique problems might you anticipate it has in its supply chain? What might remedy these problems?
...
59. Discuss the business value of supply chain management systems.
...
60. A []{.gap} is an interaction with a customer. {.quiz}
    - point of presence
    - touch point {.correct}
    - sales point
    - client channel
...
61. Which of the following would not be considered a contact point? {.quiz}
    - Email
    - Website
    - Intranet {.correct}
    - Retail store
...
62. []{.gap} software modules deal with setting employee objectives, performance, and compensation. {.quiz}
    - SCM
    - SFA
    - ERM {.correct}
    - DRM
...
63. []{.gap} software modules seek to enhance collaboration between a company and its selling partners. {.quiz}
    - SCM
    - SFA
    - ERM
    - DRM
...
64. CRM systems typically provide software and online tools for sales, customer service, and: {.quiz}
    - marketing. {.correct}
    - account management.
    - advertising.
    - public relations.
...
65. SFA modules in CRM systems provide tools for all of the following except: {.quiz}
    - team selling.
    - territory management.
    - sales forecasting.
    - managing sales prospect and contact information.
    - managing customer service requests. {.correct}
{.options}

66. CRM systems help businesses achieve which of the following business objectives? {.quiz}
    - Automated accounting processes
    - Automated production forecasts
    - Faster time to market with new products and services
    - Enhanced supplier intimacy
    - Enhanced customer intimacy {.correct}
{.options}

67. Customer service modules in CRM systems provide tools for: {.quiz}
    - assigning and managing customer service requests. {.correct}
...
68. Marketing modules in CRM systems provide tools for all of the following except: {.quiz}
    - tools for assessing its selling partners' performance. {.correct}
    - capturing prospect and customer data.
    - identifying profitable and unprofitable customers.
    - qualifying leads.
...
69. Selling a customer with a checking account a home improvement loan is an example of: {.quiz}
    - operational CRM.
    - direct marketing.
...
70. Major CRM products typically have all of the following service capabilities except: {.quiz}
...
71. Major CRM software products include which of the following capabilities to support the sales process? {.quiz}
    - Returns management
...
72. Which of the following applications provides analysis of customer data? {.quiz}
    - Operational CRM
...
73. Operational CRM applications include tools for all of the following except: {.quiz}
    - sales force automation.
    - call center support.
    - marketing automation.
    - customer service support.
    - calculating CLTV. {.correct}
{.options}

74. Which of the following tools is used to analyze customer buying patterns? {.quiz}
    - CLTV
    - Analytical CRM {.correct}
    - Operational CRM
    - Demand planning
...
75. Which metric is based on the relationship between the revenue produced by a specific customer, the expenses incurred in acquiring and servicing that customer, and the expected life of the relationship between the customer and the company? {.quiz}
    - Churn rate
    - CLTV {.correct}
    - Cost per lead
    - Cost per sale
...
76. The measurement of the number of customers who stop using or purchasing products or services from a company is called: {.quiz}
    - switching costs.
    - churn rate. {.correct}
    - CLTV.
    - switch rate.
...
77. []{.gap} modules in CRM systems help sales staff increase their productivity by focusing sales efforts on the most profitable customers, those who are good candidates for sales and services. {.quiz}
    - Customer
    - SOA
    - Marketing
    - Complex
...
78. Which of the following is not a major CRM application software vendor? {.quiz}
    - Microsoft
    - Oracle
    - SAP
    - JDA Software {.correct}
    - Salesforce.com
{.options}

79. All CRM packages contain modules for PRM and ERM. {.quiz .false}

80. CRM software incorporates hundreds of business processes. {.quiz .true}

81. Cross-selling is the marketing of products to different customers. {.quiz .false}

82. A PRM module in CRM software helps organizations identify high-value customers for preferential treatments. {.quiz .false}

83. Analytical CRM uses tools to analyze customer data collected from the firm's customer touch points and from other sources. {.quiz .true}

84. Churn rate is an important indicator of the growth or decline of a company's customer base. {.quiz .true}

85. Discuss the difference between operational CRM and analytical CRM.
...
86. Discuss the business value of having an effective CRM system.
...
87. You have been hired by Croydon Visiting Nurse Services, whose business processes are all manual, paper-based processes. How might a CRM system benefit them?
...
88. What are four questions that a good CRM system can help answer and how do firms use the answers to those questions?
...
89. What is a PRM module? How does it differ from an ERM module?
...
90. Which of the following statements about enterprise applications is not true? {.quiz}
    ...
    - Companies adopting enterprise applications can also save time and money by extensively customizing their applications to fit their business processes. {.correct}
{.options}

91. Which of the following is not an example of a next-generation enterprise application? {.quiz}
    - SAP S/4HANA Cloud
    - Social CRM
    - SAP R/3 {.correct}
...
92. According to a 2020 survey of 181 ERP users conducted by Panorama Consulting Group, 38 percent of ERP projects experienced cost overruns, and these overruns averaged []{.gap} percent over budget. {.quiz}
    - 25
    - 33
    - 50
    - 66 {.correct}
...
93. Which of the following is not a business intelligence feature of SAP's next generation business intelligence applications? {.quiz}
    - Employee relationship management {.correct}
...
94. Which of the following enables a business to connect customer conversations and relationships from social networking sites to CRM processes? {.quiz}
    - Analytical CRM
    - Social CRM {.correct}
    - Operational CRM
    - PRM module
...
95. Enterprise systems do not require fundamental changes in the way the business operates. {.quiz .false}

96. Enterprise applications reduce switching costs. {.quiz .false}

97. Enterprise applications are based on organization-wide definitions of data. {.quiz .true}

98. Stand-alone enterprise systems are becoming a thing of the past. {.quiz .true}

99. What is social CRM and how is it being used?
...
100. Identify and briefly describe at least four challenges involved in implementing an enterprise system.
