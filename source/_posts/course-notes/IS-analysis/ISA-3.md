...
layout: post
title: UML 建模方法整合
description: 整合 UML 用例图、类图、活动图、时序图、状态图、构件图和部署图，说明各类图回答的问题、适用阶段、核心元素与常见错误，帮助按建模目标选择合适图形。
...
mermaid: true
---
> 整合 UML 用例图、类图、活动图、时序图、状态图、构件图和部署图，说明各类图回答的问题、适用阶段、核心元素与常见错误，帮助按建模目标选择合适图形。
