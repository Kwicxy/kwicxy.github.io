...
1. Which of the following is the first value-adding step of information system activities in the knowledge management value chain? {.quiz}
    - Feedback
    - Acquire {.correct}
    - Disseminate
    - Store
...
2. Which of the following involves where, when, and how to apply knowledge? {.quiz}
    - Data
    - Wisdom {.correct}
    - Tacit knowledge
    - Explicit knowledge
...
3. Which of the following statements best describes the relationship between collaboration and knowledge management? {.quiz}
    - Collaboration is impossible without knowledge.
    - Knowledge is impossible without collaboration.
    - Knowledge that cannot be communicated and shared with others is nearly useless. {.correct}
    - As knowledge improves, so does collaboration.
    - Knowledge is the result of collaboration.
{.options}

4. The text defines []{.gap} as flows of events or transactions captured by an organization's systems. {.quiz}
    - information
    - data {.correct}
    - wisdom
    - knowledge
...
5. The text defines []{.gap} as expertise of organizational members that has not been formally documented. {.quiz}
    - wisdom
    - information
    - data
    - experience
...
6. Which of the following statements is not an accurate description of the importance of knowledge to a firm? {.quiz}
    ...
    - Knowledge is subject to the law of diminishing returns. {.correct}
    - The transformation of data into useful information and knowledge requires organizational resources.
{.options}

7. What is meant by the statement "knowledge is sticky"? {.quiz}
    - Knowledge is hard to move. {.correct}
...
8. Which of the following is not one of the main four dimensions of knowledge described in the chapter? {.quiz}
    - Knowledge is a firm asset.
    - Knowledge has different forms.
    - Knowledge has a location.
    - Knowledge is situational.
    - Knowledge is timeless. {.correct}
{.options}

9. Changing organizational behavior by sensing and responding to new experience and knowledge is called: {.quiz}
    - change management.
    - knowledge leveraging.
    - the knowledge value chain.
    - organizational learning. {.correct}
    - knowledge management.
{.options}

10. What is the second value-adding step in information system activities in the knowledge management value chain? {.quiz}
    - Acquire
    - Feedback
    - Store {.correct}
    - Disseminate
...
11. The set of business processes, culture, and behavior required to obtain value from investments in information systems is one type of: {.quiz}
    - knowledge culture.
    - knowledge discovery.
    - organizational and management capital. {.correct}
    - organizational routine.
    - knowledge.
{.options}

12. Which of the following are the three major types of knowledge management systems? {.quiz}
    - MIS, DSS, and TPS
    - CRM, SCM, and CAD
    - DBMS, DSS, and ECM
    - COPs, ECM, and MIS
    - Enterprise-wide knowledge management systems, KWS, and intelligent techniques {.correct}
{.options}

13. Specialized systems that enable scientists and engineers to create and discover new knowledge for a company are called: {.quiz}
    - KWS. {.correct}
    - LMS.
    - wikis.
    - COPs.
...
14. Which of the following statements about knowledge is not true? {.quiz}
    - Knowledge involves knowing how to follow procedures.
    - Knowledge involves causality.
    - Knowledge is not subject to network effects. {.correct}
    - Knowledge is a cognitive event involving mental models.
    - Knowledge can be either tacit or explicit.
{.options}

15. Informal social networks of professionals and employees within and outside the firm who have similar work-related activities and interests are called communities of: {.quiz}
    - practice. {.correct}
    - professionals.
    - interest.
    - knowledge.
...
16. All of the following are intangible assets of a firm except its: {.quiz}
    - brand.
    - reputation.
    - knowledge.
...
17. COPs can make it easier for people to reuse knowledge. {.quiz .true}

18. Knowledge is conditional. {.quiz .true}

19. One apt slogan of the knowledge management field is "Effective knowledge management is 80 percent technological and 20 percent managerial and organizational." {.quiz .false}

20. The impacts of knowledge-based investments are easy to measure. {.quiz .false}

21. Document management systems are essentially large databases. {.quiz .true}
...
23. Briefly outline the information system and management and organizational activities in a knowledge management value chain as it might apply to the online catalog system of a public library.
...
24. Identify the three major types of knowledge management systems. Provide two examples of each.
...
25. What is a community of practice, and how do they make it easier for people to reuse knowledge?
...
27. Which of the following statements about genetic algorithms is not true? {.quiz}
    ...
    - Genetic algorithms discover knowledge by using hardware and software that parallel the processing patterns of the biological or human brain. {.correct}
{.options}

28. Which of the following is an intelligent personal assistant? {.quiz}
    - GE's Predix
    - Amazon's Alexa {.correct}
    - Facebook's DeepFace
    - IBM's Watson
    - WellsFargo's Aiera
{.options}

29. Apple's Siri application is an example of which of the following? {.quiz}
    - Neural network
    - Augmented reality
    - Genetic algorithm
...
30. An inference engine is: {.quiz}
    ...
    - a strategy used to search through an expert system's collection of rules and formulate conclusions. {.correct}
    - a programming algorithm used to create a virtual world using a deep learning system.
{.options}

31. Which of the following is not true about the evolution of AI technologies? {.quiz}
    - There have been many fundamental conceptual breakthroughs in AI during the last decade. {.correct}
...
32. Which of the following is not a major benefit of expert systems? {.quiz}
    - Improved decisions
    - Better quality and service
    - Ability to scale to deal with very large data sets {.correct}
    - Reduced errors
    - Reduced training time
{.options}

33. Which of the following statements about expert systems is not true? {.quiz}
    ...
    - Expert system development has grown rapidly in the last decade. {.correct}
    - Expert systems are not useful for dealing with unstructured problems.
    - Expert systems are expensive to build.
{.options}

34. An expert system would be an appropriate application for making decisions for all of the following except: {.quiz}
    - legal research
    - medical diagnostics
    - a recommender system {.correct}
    - civil engineering
    - personalized learning and responsive testing
{.options}

35. Which of the following statements about machine learning is not true? {.quiz}
    ...
    - Machine learning is based on computer code that reflects rules underlying an expert's understanding. {.correct}
{.options}

36. Supervised machine learning involves: {.quiz}
    - programmers supervising the machine learning program.
    - training a system by providing specific examples of desired inputs and outputs identified by humans in advance. {.correct}
...
37. Unsupervised machine learning involves: {.quiz}
    - using very large databases to store common sense knowledge, then searching the database for patterns.
    - using algorithms to simulate the neurons and synapses of human brains.
    - programs that can "teach themselves" without human intervention. {.correct}
...
40. Which of the following best describes a difference between neural networks and genetic algorithms? {.quiz}
    ...
    - Genetic algorithms are used to evaluate alternative solutions to problems, whereas neural networks are used to discover patterns in data. {.correct}
...
41. Genetic algorithms: {.quiz}
    - are a form of machine learning. {.correct}
...
42. Software programs that work without direct human intervention to carry out specific tasks for individual users, business processes, or software applications, are called: {.quiz}
...
43. All of the following are examples of machine learning except: {.quiz}
    - CAD systems {.correct}
...
44. Deep learning networks: {.quiz}
    - rely on humans to help it identify patterns.
    - use multiple layers of neural networks to detect patterns in input data. {.correct}
...
45. The seminal research effort often referred to as "The Cat Paper" involved which of the following? {.quiz}
    - Expert system
...
46. Which of the following statements about natural language processing (NLP) is not true? {.quiz}
    ...
    - NLP relies on the use of an expert system. {.correct}
    - NLP can infer customers' specific needs when they call help centers.
    - NLP often uses neural networks.
{.options}

47. GumGum's system relies on which of the following? {.quiz}
    - Genetic algorithms
    - Expert systems
    - Human monitoring
    - Intelligent personal agents
    - Computer vision system {.correct}
{.options}

48. A chatbot is an example of which of the following? {.quiz}
...
49. In an expert system, the set of rules that models human knowledge is called: {.quiz}
    - the knowledge base. {.correct}
...
50. A(n) []{.gap} is a type of intelligent technique that finds patterns and relationships in massive data sets too large for a human to analyze. {.quiz}
    - inference engine
    - CAD
    - expert system
    - genetic algorithm
...
51. Which of the following statements about robotics is not true? {.quiz}
    ...
    - Robotics does not require programming but instead relies solely on AI. {.correct}
    - Robotics has widespread use in manufacturing.
{.options}

52. Some commentators believe which of the following comes closest to the "Grand Vision" of AI? {.quiz}
    - Expert systems
    - Deep learning networks {.correct}
    - Genetic algorithms
    - Intelligent agents
    - Robotics
{.options}

53. Which of the following statements about neural networks is not true? {.quiz}
    - Software programs and mathematical models perform the function of biological neurons in a neural network.
    - The strength of the connections between neurons in a neural network cannot be altered. {.correct}
...
54. An expert system cannot consider multiple rules at the same time. {.quiz .false}

55. Expert systems capture the knowledge of skilled employees in the form of a set of rules in a software system that can be used by others in the organization. {.quiz .true}

56. Expert systems use real-time data to guide their decisions. {.quiz .false}

57. Expert systems work by applying a set of decision cases against a knowledge base, both of which are extracted from human experts. {.quiz .false}

58. Neural networks are not well-suited for diagnostic systems in medicine. {.quiz .false}

59. Deep learning neural networks are used almost exclusively for pattern detection on unlabeled data. {.quiz .true}

60. Some intelligent agent systems are capable of learning from experience and adjusting their behavior. {.quiz .true}

61. Neural network applications explain why they arrive at a particular solution. {.quiz .false}

62. AI applications are used by search engines and social networks to target ads. {.quiz .true}

63. Facebook's DeepFace is an example of a computer vision system. {.quiz .true}

64. Babies have a huge computational advantage over even the biggest machine language research systems. {.quiz .true}

65. What is the difference between a neural network and a genetic algorithm? Which would be most useful to an organization of astronomers analyzing gamma ray emissions reaching Earth?
...
66. What are the differences between human intelligence and artificial intelligence?
...
67. What is a chatbot and how are they used in business?
...
68. How do machine learning systems like neural networks actually "learn"?
...
69. Describe some of the ways we use machine learning technologies every day.
...
70. []{.gap} knowledge exists in formal documents, as well as in formal rules that organizations derive by observing experts and their decision-making behaviors. {.quiz}
    - Unstructured
    - Tacit
    - Management
    - Explicit
...
71. Which of the following types of system enables organizations to digitize, index, and tag structured and unstructured knowledge and documents according to a coherent framework? {.quiz}
    - Wikis
    - CAD
    - ECM {.correct}
    - LMS
...
72. All of the following are typical components or capabilities of an ECM system except: {.quiz}
    - knowledge portals.
    - distribution tools.
    - tagging tools.
    - interfacing with corporate databases.
    - artificial intelligence tools. {.correct}
{.options}

73. Which of the following would not be considered semistructured knowledge? {.quiz}
    - Corporate annual report {.correct}
    - Voice mail
    - Videos
    - Email
...
74. Which of the following statements about an ECM system is not true? {.quiz}
    - Each knowledge object in an ECM system needs to be tagged.
    - ECM systems only enable users to access internal sources of information. {.correct}
...
75. You are advising a video production company on the best type of knowledge management system to help them archive digital video and sound clips. Which of the following will best suit their needs? {.quiz}
    - MOOC
    - Digital asset management system {.correct}
    - CAD system
    - Virtual reality system
    - LMS
{.options}
...
76. A MOOC is: {.quiz}
    - a type of online course. {.correct}
...
77. Which of the following provides tools for the management, delivery, tracking, and assessment of various types of employee learning? {.quiz}
...
78. A key problem in managing knowledge is the creation of a(n) []{.gap} to organize the information into meaningful categories. {.quiz}
...
79. Coca-Cola uses a []{.gap} in order to classify, store and distribute all the images of the brand. {.quiz}
    - digital asset management system {.correct}
    - virtual reality system
...
80. MOOCs are designed to serve a limited number of participants. {.quiz .false}

81. According to experts, at least 80 percent of an organization's business content is semistructured or unstructured. {.quiz .true}

82. Semistructured information is all the knowledge in a firm that resides in the heads of experienced employees. {.quiz .false}

83. How can knowledge be gathered from the personal and undocumented expertise of professionals within a firm?
...
84. You have been hired by a small architectural firm interested in implementing a knowledge management system. What features do you think would be of most benefit to them?
...
85. Which of the following statements about 3-D printing is not true? {.quiz}
    - It is able to create solid objects.
    - It is also called additive manufacturing.
    - It often results in wasted materials. {.correct}
    - It creates objects layer by layer.
    - It uses specifications in a digital file.
{.options}

86. All of the following are considered to be knowledge workers except: {.quiz}
    - designers.
    - engineers.
    - architects.
    - executives. {.correct}
...
87. CAD workstations: {.quiz}
    - enable design specifications for tooling and manufacturing processes to be easily tested and changed. {.correct}
...
88. Which of the following would not be classified as a KWS? {.quiz}
    - CAD system
    - 3-D printing system
    - AR application
...
89. VR systems: {.quiz}
    ...
    - sometimes require the user to don special clothing, headgear, or equipment. {.correct}
    - enable acquiring, storing, and disseminating knowledge documents in a virtual world.
{.options}

90. Which of the following seeks to enhance human perception by combining a live direct view of the physical world with computer-generated images? {.quiz}
...
91. Which of the following statements about augmented reality is not true? {.quiz}
    ...
    - Augmented reality is a method of organizing expert system knowledge into chunks. {.correct}
...
92. 3-D printers can produce fully functioning components, such as working batteries and LEDs. {.quiz .true}

93. CAD and virtual reality are both types of KWS. {.quiz .true}

94. Knowledge workers include all of a company's workers who are tasked with managing or creating knowledge, from top-level scientists to clerical and data workers. {.quiz .false}

95. Knowledge work systems require strong links to external knowledge bases. {.quiz .true}

96. Today's 3-D printers can create objects out of human cartilage. {.quiz .true}

97. The yellow first-down markers shown on televised football games are examples of AR. {.quiz .true}

98. Describe the typical characteristics of knowledge workers and the roles they play within a firm. Why are knowledge workers so important to the digital firm? What are their functions and which of these do you feel is most critical to the success of the firm? Why?
...
99. What are three important qualities or capabilities of a KWS?
...
100. Discuss the concept of virtual reality, especially with regard to its applications in the business arena.
