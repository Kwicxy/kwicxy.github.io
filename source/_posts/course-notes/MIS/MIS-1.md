...
layout: post
title: 第1章 信息系统与企业转型
description: 介绍信息系统和信息技术如何支持企业转型，梳理管理信息系统的基本活动、组织维度与业务价值。
...
tags:
  ...
  - 数字化转型
---
> 介绍信息系统和信息技术如何支持企业转型，梳理管理信息系统的基本活动、组织维度与业务价值。
...
沃尔玛将供应商与每个零售商店之间进行数据链接。一旦顾客购买了商品，监控商品的供应商就知道要把一个替代品运送到货架上。
沃尔玛的供应链管理运营效率远远高于其竞争对手。
...
顾客进入房间后，系统自动根据客户的画像特征，设置房间环境（灯光、温度、音乐），开展有针对性的营销活动。
+++

- 供应链管理(SCM)系统帮助企业与供应商建立更亲密关系，以降低成本。

+++ 举例：杰西潘尼
杰西潘尼(JCPenney)公司的信息系统可以将销售记录与供应商相连接。
顾客在美国的杰西潘尼商店购买一件衬衫，信息就会立刻出现在香港制造商TAL服饰有限公司（ TAL Apparel Ltd.）的电脑上。
TAL公司通过它开发的一个计算机决策模型来决定要生产多少数量的衬衫（包括确定衬衫的样式、颜色和尺寸等），然后，把衬衫送到每一家杰西潘尼商店，完全绕开零售商。
也就是说，杰西潘尼的衬衫库存接近于零，而存储成本也是如此。
+++

+++ 举例：克莱斯勒
克莱斯勒公司使用信息系统来帮助供应商直接进入生产计划，甚至允许供应商决定如何以及何时向克莱斯勒的工厂运送原材料，这使得供应商在生产商品方面有更多的领先时间。
...
1. 生产过剩或生产不足；
2. 资源误置、资源错配；
3. 对客户、供应商和外部竞争环境的响应时间加长。

这样决策最终会增加成本，失去顾客。

+++ 举例: Verizon
Verizon（威瑞森电信）公司是美国最大的电信公司之一，它使用基于网络的数字仪表盘（dashboard），向管理人员提供关于客户投诉、网络性能、线路断电等精确的实时信息。
